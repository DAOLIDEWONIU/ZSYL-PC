...
$index['support_name'] = $dou->dou_substr($dou->get_one("SELECT page_name FROM ". $dou->table('page') . " WHERE id = '8'"), 300);
$index['support_content'] = $dou->get_one("SELECT content FROM " . $dou->table('page') . " WHERE id = '8'");
