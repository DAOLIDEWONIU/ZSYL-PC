 ...
 <ul class="wrap">
  ...
  <li id="join">
  	...
  	<div class="join-hover">
    	...
    	<i class="sanjiao"></i>
        <div class="join-hover-in">
            <a href="http://company.zhaopin.com/CC386903983.htm" target="_blank"><i class="zhilian"></i></a>
            <a href="http://jobs.51job.com/all/co3874029.html" target="_blank"><i class="job"></i></a>
        </div>
    </div>
  </li>
  <div class="clear"></div>
